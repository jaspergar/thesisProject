...
public class NotTopRatedSingerPerformerAdapter extends RecyclerView.Adapter<NotTopRatedSingerPerformerAdapter.MyViewHolder> {

    private Context mContext;
    private List<PERFORMERFINAL> performerfinalList;
    PerformerItemClickListener performerItemClickListener;
    String s;
    public NotTopRatedSingerPerformerAdapter(Context mContext, List<PERFORMERFINAL> performerfinalList, PerformerItemClickListener performerItemClickListener) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_performer_nottoprated,parent,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            relativeLayout = itemView.findViewById(R.id.nottoprated_per_rl);

            follow = itemView.findViewById(R.id.browse_performer_btnfollow);
            unfollow = itemView.findViewById(R.id.browse_performer_btnunfollow);

            performerPhoto = itemView.findViewById(R.id.browse_performer_photo);
            performerName = itemView.findViewById(R.id.browse_performer_name);
            performerRating = itemView.findViewById(R.id.browse_performer_rating);
            performerType = itemView.findViewById(R.id.browse_performer_type);
