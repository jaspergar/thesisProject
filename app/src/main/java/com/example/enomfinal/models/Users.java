...
//temporary
    ...
    public Users(int e_id, String e_email, String e_password, String e_fname, String e_lname, String e_gender, String e_dob, String e_type, String e_cnumber, String e_photo) {
        this.e_id = e_id;
...
//temporary
    public Users(int photo, String e_fname, String e_lname) {
        this.photo = photo;
        this.e_fname = e_fname;
        this.e_lname = e_lname;
    }
